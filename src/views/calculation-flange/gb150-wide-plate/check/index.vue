            ...
            <el-row :gutter="10">
              <el-col :span="24">
                ...
                <el-descriptions :column="2">
                  ...
                  <el-descriptions-item :label="Label(general_output.FR_)">{{
                      general_output.FR_.value
                    }}
                  </el-descriptions-item>
                </el-descriptions>
              </el-col>
  ...
  methods: {
    calculate() {
      try {
        ...
        const CS_2 = CS_1 * 1.2
        const Wp_ = SC_ * 1000 * n / (0.2 * dB)
        const FR_ = (FD * LD + Wp_ * Ebt * Lp_ / Eb - F_ * Lp_ + FT_ * Lt_) / (Lp_ + LR)
        ...
        this.general_output.Wp_.value = round(Wp_, precision)
        this.general_output.FR_.value = round(FR_, precision)
    ...
    clean1() {
      ...
      this.general_output.Wp_.value = '--'
      this.general_output.FR_.value = '--'
    },
    clean2() {
