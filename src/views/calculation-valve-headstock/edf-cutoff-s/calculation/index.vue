            ...
            <el-row :gutter="10">
              <el-col :span="24">
                <el-descriptions :column="3">
                  ...
                  <el-descriptions-item :label="Label(general_output.Q4)">{{
                      general_output.Q4.value
                    }}
                  </el-descriptions-item>
  ...
  methods: {
    calculate() {
      try {
        ...
        this.general_output.Q4.value = round(Q4, precision)
