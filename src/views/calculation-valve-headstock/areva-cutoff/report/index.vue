        ...
        <div id="print-area">
          ...
          <div class="report-panel" style="margin-bottom: 20px">
            <table class="custom-table">
              ...
              <custom-tr section="输入参数（系统与参数结构）" input_output="input" para="L"></custom-tr>
              ...
              <custom-tr section="中间过程参数" input_output="output" para="Q1" rowspan="9"></custom-tr>
              ...
              <custom-tr section="中间过程参数" input_output="output" para="Q4_1"></custom-tr>
              <custom-tr section="中间过程参数" input_output="output" para="Q4_2"></custom-tr>
              ...
              <tr>
                <td>
                  <div class="custom-cell">
                    {{ formatLabel(general.input.Q4_type) }}
                  </div>
                </td>
                <td>
                  <div class="custom-cell">
