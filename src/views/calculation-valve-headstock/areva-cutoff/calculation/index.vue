      ...
      <el-col :span="20">
        ...
        <el-form label-width="80px">
          <el-card class="box-card" shadow="hover">
            ...
            <el-row :gutter="6">
              <el-col :span="6">
                <custom-el-input :para="general_input.L"></custom-el-input>
              </el-col>
            </el-row>
          ...
          <el-card class="box-card" shadow="hover">
            ...
            <el-row :gutter="10">
              <el-col :span="24">
                ...
                <el-descriptions :column="2">
                  <el-descriptions-item :label="Label(general_output.Q4_1)">{{
                      general_output.Q4_1.value
                    }}
                  </el-descriptions-item>
                  <el-descriptions-item :label="Label(general_output.Q4_2)">{{
                      general_output.Q4_2.value
                    }}
                  </el-descriptions-item>
                </el-descriptions>
              </el-col>
          ...
          <el-card class="box-card" shadow="hover">
            ...
            <el-row :gutter="10">
              <el-col :span="6">
                <custom-el-input :para="general_output.Q4_1" :disabled="true"
                                 v-if="general_input.Q4_type.value===1"></custom-el-input>
                <custom-el-input :para="general_output.Q4_2" :disabled="true" v-else></custom-el-input>
              </el-col>
              <el-col :span="18">
                <el-form-item :label="general_input.Q4_type.meaning" label-width="250px" size="small" :inline="true">
                  <el-radio-group v-model="general_input.Q4_type.value">
                    <el-radio :label="general_input.Q4_type.items[0].selection">{{
                        general_input.Q4_type.items[0].meaning
                      }}
                    </el-radio>
                    <el-radio :label="general_input.Q4_type.items[1].selection">{{
                        general_input.Q4_type.items[1].meaning
                      }}
                    </el-radio>
                  </el-radio-group>
                </el-form-item>
  ...
  methods: {
    calculate() {
      try {
        ...
        const L = this.general_input.L.value
        ...
        const Q4_type = this.general_input.Q4_type.value
        ...
        const C = (Q1 + Q2 + Q3 + Q4 - Q5 + Q6) * Tf / RCAD / 1000
        ...
        this.general_output.Q4_1.value = round(Q4_1, precision)
        this.general_output.Q4_2.value = round(Q4_2, precision)
    ...
    clean3() {
      ...
      this.general_input.Q4_type.value = 1
      ...
      this.general_output.Q4_1.value = '--'
      this.general_output.Q4_2.value = '--'
