        ...
        <div id="print-area">
          ...
          <div class="report-panel" style="margin-bottom: 20px">
            <table class="custom-table">
              ...
              <tbody>
              <custom-tr section="输入参数" input_output="input" para="PMS" rowspan="7"></custom-tr>
              ...
              <custom-tr section="输入参数" input_output="input" para="K"></custom-tr>
              <custom-tr section="输入参数" input_output="input" para="N"></custom-tr>
              <custom-tr section="输入参数" input_output="output" para="Pg"></custom-tr>
