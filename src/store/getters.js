const getters = {
  ...
  current_case_index: state => state.parameter_current_case.index,
  ...
  flange_gb150_wide_plate: state => state.parameter_flange_gb150_wide_plate.general,
  flange_gb150_wide_hubbed: state => state.parameter_flange_gb150_wide_hubbed.general,
  flange_gb150_narrow: state => state.parameter_flange_gb150_narrow.general,
  ...
  valve_headstock_areva_sluice: state => state.parameter_valve_headstock_areva_sluice.general,
  valve_headstock_areva_cutoff: state => state.parameter_valve_headstock_areva_cutoff.general,
